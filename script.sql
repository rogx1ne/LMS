...
-- 007 PRODUCTION FIX: Creates tables and schema
-- User drop/recreate is handled by Java setup
-- ============================================

-- This script runs as PRJ2531H after the user has been
-- dropped and recreated by the Java setup wizard (as SYSTEM).
-- It ONLY creates tables, sequences, and indexes.
