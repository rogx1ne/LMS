...
CREATE TABLE TBL_BOOK_INFORMATION (
    ...
    BK_SUBJECT  VARCHAR2(50), -- SUBJECT OF THE BOOK
    BK_COURSE   VARCHAR2(50), -- COURSE CATEGORY
    BK_YEAR     VARCHAR2(20), -- ACADEMIC YEAR (1st, 2nd, etc.)
    BK_TYPE     VARCHAR2(20) DEFAULT 'BOOK', -- BOOK, REPORT, PROJECT
